...
public class request {
    ...
    public void reqRight(String date) {
        ...
        $(By.xpath("//td[contains(text(),'Подъезд')]/following::td[1]//input")).shouldHave(value("2"));
        $(By.xpath("//span[contains(text(),'Этаж')]/following::span[1]//input")).shouldHave(value("3"));
        $(By.xpath("//span[contains(text(),'Квартира')]/following::span[1]//input")).shouldHave(value("10"));
